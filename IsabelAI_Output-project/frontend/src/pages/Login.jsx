...
export default function Login() {
  ...
  return (
    <div style={{ minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",background:"#06050e",padding:24,position:"relative",overflow:"hidden" }}>
      {/* Background orbs */}
      <div style={{ position:"absolute",borderRadius:"50%",filter:"blur(80px)",width:600,height:600,background:"rgba(90,25,200,.25)",top:-200,left:-200,pointerEvents:"none" }} />
      <div style={{ position:"absolute",borderRadius:"50%",filter:"blur(80px)",width:400,height:400,background:"rgba(200,77,255,.12)",bottom:-150,right:-150,pointerEvents:"none" }} />
      ...
      <div style={{ width:"100%",maxWidth:420,position:"relative",zIndex:2 }}>
        ...
        <div style={{ textAlign:"center",marginBottom:36 }}>
          ...
          <h1 style={{ fontFamily:"'Syne',sans-serif",fontSize:28,fontWeight:800,color:"#fff",marginBottom:6 }}>
            Welcome back to <span style={{ background:"linear-gradient(130deg,#a67cff,#c84dff)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent" }}>Isabel</span>
          </h1>
          <p style={{ fontSize:14,color:"rgba(232,228,255,.45)" }}>Sign in to continue your conversations</p>
        </div>
        ...
        <div style={{ background:"#0f0d1e",border:"1px solid rgba(124,77,255,.2)",borderRadius:20,padding:36 }}>
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={loading}
              style={{ width:"100%",padding:"13px",borderRadius:11,background: loading?"rgba(124,77,255,.5)":"#7c4dff",border:"none",color:"#fff",fontFamily:"'DM Sans',sans-serif",fontSize:15,fontWeight:500,cursor: loading?"not-allowed":"pointer",marginTop:8,boxShadow:"0 0 30px rgba(124,77,255,.4)",transition:"all .2s",display:"flex",alignItems:"center",justifyContent:"center",gap:8 }}
            >
              {loading ? (
                <><div style={{ width:16,height:16,border:"2px solid rgba(255,255,255,.3)",borderTop:"2px solid #fff",borderRadius:"50%",animation:"spin 1s linear infinite" }} />Signing in...</>
              ) : "Sign In →"}
            </button>
          </form>
          ...
          <div style={{ textAlign:"center",marginTop:24,fontSize:14,color:"rgba(232,228,255,.45)" }}>
            ...
            <Link to="/register" style={{ color:"#a67cff",textDecoration:"none",fontWeight:500 }}>Sign up free</Link>
          </div>
        </div>
